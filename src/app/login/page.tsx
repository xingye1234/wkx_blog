...
export default function page() {
  return (
    <div className='animate-fade-right animate-duration-1000 animate-delay-100 w-full h-screen bg-[url("/login-bg.jpg")] bg-cover flex justify-center items-center items-center'>
